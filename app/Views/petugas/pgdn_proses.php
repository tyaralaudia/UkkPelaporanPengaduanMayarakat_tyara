                                ...
                                foreach ($pgdn as $p) : ?>
                                    <tr align="center">
                                        ...
                                        <td>
                                            ...
                                            <?php if ($p['status'] == '0') : ?>
                                                <a href="/petugas/pengaduan/proses/<?= $p['id_pengaduan']; ?>" class="btn btn-sm btn-info mb-2" onclick="return confirm('Aksi ini akan mengubah status menjadi \'Proses\'. Apakah Anda yakin?')" title="Update Status = Proses"> Proses</a>
                                            <?php endif ?>
